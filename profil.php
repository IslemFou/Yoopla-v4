                ...
                <form action="#" method="POST" class="mt-3 p-4 bg-light rounded-4 bg-opacity-25">
                    ...
                    <div class="mt-3 row">
                        ...
                        <div class="mt-3 col">
                            ...
                            <input type="text" name="firstName" class="form-control rounded-5" placeholder="First name" aria-label="First name">
                        </div>
                        <div class="mt-3 col">
                            <label for="lastName" class="form-label">Nom</label>
                            <input type="text" name="lastName" class="form-control rounded-5" placeholder="Last name" aria-label="Last name">
                        </div>
                    </div>
                    <div>
                        <div class="mt-3 col">
